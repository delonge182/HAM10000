...
\end{Verbatim}
    ...
    \hypertarget{correlation-between-additional-features}{%
...
customization.
    ...
    \hypertarget{cnn-with-customized-layer-for-multiple-input}{%
...
\end{Verbatim}
    ...
    \hypertarget{cnn-with-transfer-learning-and-data-augmentation}{%
...
score is ``dermatofibroma'', the percentage of correct answer is only
44\% and evenmore the model misclassify ``dermatofibroma'' as
``Melanocytic nevi'' 25\% of time. Another missclassification is 24\%
from total predictions of melanoma predicted as ``Melanocytic nevi''
which in this case can be fatal because if melanoma is not treated at
early staged it can be deadly.
